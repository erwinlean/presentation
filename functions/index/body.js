...
const paragraphOneSpanish = "Programador en crecimiento con experiencia en diferentes tecnologías. Me especializo en el desarrollo de aplicaciones utilizando JavaScript (Node.js, Express, Angular), también tengo conocimientos básicos Electron & Ionic. Además, manejo PHP, Linux, Docker y otras herramientas esenciales de programación.";
...
const paragraphOneEnglish = "Growing programmer with experience in various technologies. I specialize in developing applications using JavaScript (Node.js, Express, Angular), and I also have basic knowledge of Electron & Ionic. Additionally, I handle PHP, Linux, Docker, and other essential programming tools.";
